        ...
        const modalMessage = (
          <div>
            ...
            <p className={`subtitle ${textColor}`}>
              ...
              <br />
              {atomicToHuman(amount + nodeFee + fee, true)} INZ
            </p>
            <p className={`subtitle ${textColor}`}>
              <b>Fee:</b>
              <br />
              {atomicToHuman(nodeFee + fee, true)} INZ
              {nodeFee > 0 &&
    ...
    const transactionData = {
      ...
      amount:
        displayCurrency === 'INZ'
          ...
          : parseInt((Number(enteredAmount) * 100000000) / fiatPrice, 10),
      paymentID,
      sendAll
    };
    ...
    const addressInput = (
      ...
      >
        <Creatable
          ...
          placeholder="Enter a Ionize address or a contact name to send funds to"
