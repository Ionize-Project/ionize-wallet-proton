...
export default class Search extends Component<Props, States> {
  ...
  openSearchInExplorer = () => {
    ...
    remote.shell.openExternal(
      `http://explorer.ionize.xyz/?hash=${encodeURIComponent(query)}#blockchain_transaction`
    );
  };
  ...
  openInExplorer = (event: any) => {
    ...
    remote.shell.openExternal(
      `http://explorer.ionize.xyz/?hash=${encodeURIComponent(hash)}#blockchain_transaction`
    );
  };
